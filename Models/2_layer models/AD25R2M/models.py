...
def create_conv_model(fingerprint_input, model_settings, is_training):
  ...
  max_pool_1 = tf.nn.max_pool(first_dropout, [1, 2, 2, 1], [1, 2, 2, 1], 'SAME')
  ...
  second_conv = tf.nn.conv2d(max_pool_1, second_weights, [1, 1, 1, 1],
                             'SAME') + second_bias
  ...
  max_pool_2 = tf.nn.max_pool(second_dropout, [1, 2, 2, 1], [1, 2, 2, 1], 'SAME')
  second_conv_shape = max_pool_2.get_shape()
  second_conv_output_width = second_conv_shape[2]
  second_conv_output_height = second_conv_shape[1]
  second_conv_element_count = int(
      second_conv_output_width * second_conv_output_height *
      second_filter_count)
  flattened_second_conv = tf.reshape(max_pool_2,
  ...
  if is_training:
    return final_fc, dropout_prob, first_weights, second_weights
  else:
    return final_fc
