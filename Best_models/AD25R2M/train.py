...
#**************AD25R2M*******************************************
'''
This script train a two convolutional layer model for 25000 steps, 
it use Adam optimizer, l2 regularization tecnique, and a second max
 pooling layer
'''
#*****************************************************************
...
def main(_):
  ...
  with tf.name_scope('cross_entropy'):
      #  l2 regularization
      l2_reg = tf.reduce_sum([tf.nn.l2_loss(w_conv1), tf.nn.l2_loss(w_conv2)])
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='D:/Alessio/Università/Corsi/1.2_sem/human data/Progetto/dataset',
      help="""\
